...
class FAN(Backbone):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=False, pretrained=None, out_index=-1, use_checkpoint=False, out_channel=[], out_ids = [0, 1, 2, 3], patch_embed="ConvNext"):
    ...
    def forward_features(self, x):
        ...
        elif isinstance(self.patch_embed, ConvStem):
            out_list, x, (Hp, Wp) = self.patch_embed(x)
            outs = outs + out_list
            out_index = [self.out_index]
        else:
...
class fan_tiny_8_p4_hybrid(FAN):
    def __init__(self, out_ids = [0, 1, 2, 3], if_vit=False, patch_embed="ConvNext", **kwargs):
        depth = 8
        out_index=7
        if if_vit:
            depth +=2 
        ...
        super(fan_tiny_8_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=192, depth=depth, backbone=backbone,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, out_index=7, out_channel=[128, 256, 192, 768], out_ids=out_ids, use_checkpoint=True, patch_embed=patch_embed)
    ...
    def __init__(self,  out_ids = [0, 1, 2, 3], if_vit=False, patch_embed="ConvNext", **kwargs):
        ...
        super(fan_small_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=384, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, out_index=9, out_channel=[128, 256, 384, 768], out_ids=out_ids, use_checkpoint=True, patch_embed=patch_embed)
    ...
    def __init__(self,  out_ids = [0, 1, 2, 3], if_vit=False, patch_embed="ConvNext", **kwargs):
        ...
        super(fan_base_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=448, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, out_index=15, out_channel=[128, 256, 448, 768], out_ids=out_ids, use_checkpoint=True, patch_embed=patch_embed)
    ...
    def __init__(self,  out_ids = [0, 1, 2, 3], if_vit=False, patch_embed="ConvNext", **kwargs):
        ...
        super(fan_large_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=480, depth=depth, backbone=backbone,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, out_index=18, out_channel=[128, 256, 480, 768], out_ids=out_ids, use_checkpoint=True, patch_embed=patch_embed)
