...
from detrex.modeling.backbone import MyConvViT, MIMConvViT, ConvNextViT, ConvNextWindowViTBase, ConvNextWindowViTSmall, ConvNextWindowViTTiny
...
train.init_checkpoint = "model_zoo/deit_tiny_patch16_224.pth"
root_path = './output/MaskRCNNTiny/'
